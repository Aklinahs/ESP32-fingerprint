...
void loop() {
  ...
  //int x = (tft.width()  - 128) / 2 - 1;
  //int y = (tft.height() - 128) / 2 - 1;

  drawSdJpeg("/images/CMLogo.jpg", 21, 3);     // This draws a jpeg pulled off the SD Card
  delay(5000);

  //tft.fillScreen(random(0xFFFF));
  drawSdJpeg("/images/CMLogo2.jpg", 15, 0);     // This draws a jpeg pulled off the SD Card
  delay(5000);
